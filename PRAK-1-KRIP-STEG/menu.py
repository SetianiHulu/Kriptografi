...
def form_latihan1(container, back_to_menu):
    ...
    tk.Button(frame, text="Hitung", command=hitung, bg="lightblue").pack(pady=5)
...
# ---------------------------
# FORM LATIHAN 3: Nilai Akhir Akademik
# ---------------------------
...
def main():
    ...
    def show_form(form_func):
        ...
        form = form_func(container, kembali)
        form.pack(fill="both", expand=True)

    # tombol menu
    tk.Button(menu_frame, text="Latihan 1: Operasi Aritmatika", width=30, command=lambda: show_form(form_latihan1)).pack(pady=5)
    tk.Button(menu_frame, text="Latihan 2: Kalkulator Sederhana", width=30, command=lambda: show_form(form_latihan2)).pack(pady=5)
    tk.Button(menu_frame, text="Latihan 3: Nilai Akhir Akademik", width=30, command=lambda: show_form(form_latihan3)).pack(pady=5)
